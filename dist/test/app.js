...
Object.defineProperty(exports, "__esModule", { value: true });
exports.lambdaResponse = (statusCode, body) => ({
    statusCode,
    headers: {
...
exports.handler = (event) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        return helper_1.lambdaResponse(200, { body: data });
    }
    catch (e) {
        const { response: { status, data } } = e;
        console.log(`Received error: `, data);
        return helper_1.lambdaResponse(status, { message: `Unexpected error occurred with status code ${status}` });
    }
});
